    ...
    <el-form ref="form" :model="value">
      <row-span-slot>
        <template v-slot="{ span }">
          ...
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="productName" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="productStyle" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="productAddress" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="companyId" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="storeId" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="productExpiredTime" />
