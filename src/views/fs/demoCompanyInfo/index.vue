<template>
  <el-card class="app-container">
    ...
    <div style="margin-bottom: 10px" class="col-btn-display">
      <demo-company-info-add v-permission="[conf.namespace + ':save']" :action-url="conf.urlMethods.addUrl" @success="doSearch" />
    ...
    >
      <template v-slot="{doSave, preferenceData, headerDragend}">
        ...
        >
          ...
          <!-- 显示的字段-->
          <demo-company-info-columns :show-fields="showFields" :url-methods="conf.urlMethods" @success="doSearch" />
          <el-table-column
            fixed="right"
...
<script>
    ...
    import DemoCompanyInfoAdd from './add'
    ...
    import DemoCompanyInfoUpdate from './update'
    ...
    import DemoCompanyInfoDetail from './detail'
    import DemoCompanyInfoColumns from './demoCompanyInfoColumns'
    ...
    export default {
        name: 'DemoCompanyInfoIndexVue',
        components: {
          SectionTableColumn,
          TemplateConfirmBtn,
          DemoCompanyInfoColumns,
          DemoCompanyInfoDetail,
            CurdTableColumnSelect,
            DelBtn,
          DemoCompanyInfoUpdate,
            CurdPagination,
            HfTable, DemoCompanyInfoAdd,
          FormItemColDict,
          FormItemCol,
          SimpleSearch,
