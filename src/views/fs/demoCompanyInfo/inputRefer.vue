...
<script>
    ...
    export default {
        name: 'DemoCompanyInfoInputRefer',
        components: { DemoCompanyInfoColumns, CurdPagination, HfTable, SimpleSearch,
          FormItemColDict,
          FormItemCol,
          RowSpanSlot },
        props: {
            ...
            rowDbClick(row, column, event) {
                if (this.value) {
                    if (this.valueReferId) {
                        this.$set(this.value, this.valueReferId, row.companyId)
                    }
                    if (this.valueReferName) {
                        this.$set(this.value, this.valueReferName, row.companyName)
                    }
