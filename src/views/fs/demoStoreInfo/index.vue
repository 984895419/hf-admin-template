...
<script>
    ...
    import DemoStoreInfoAdd from './add'
    ...
    import DemoStoreInfoUpdate from './update'
    ...
    import DemoStoreInfoDetail from './detail'
    import DemoStoreInfoColumns from './demoStoreInfoColumns'
    ...
    export default {
        name: 'DemoStoreInfoIndexVue',
        components: {
          DemoCompanyInfoInputRefer,
          SectionTableColumn,
          TemplateConfirmBtn,
          DemoStoreInfoColumns,
          DemoStoreInfoDetail,
            CurdTableColumnSelect,
            DelBtn,
          DemoStoreInfoUpdate,
            CurdPagination,
            HfTable, DemoStoreInfoAdd,
          FormItemColDict,
          FormItemCol,
          SimpleSearch,
