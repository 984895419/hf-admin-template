...
<script>
    ...
    export default {
        name: 'DemoStoreInfoInputRefer',
        components: { DemoStoreInfoColumns, CurdPagination, HfTable, SimpleSearch,
            ...
            rowDbClick(row, column, event) {
                if (this.value) {
                    if (this.valueReferId) {
                        this.$set(this.value, this.valueReferId, row.storeId)
                    }
                    if (this.valueReferName) {
                        this.$set(this.value, this.valueReferName, row.storeName)
                    }
