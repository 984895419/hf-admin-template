...
<script>
    ...
    export default {
        name: 'DemoCompositionInfoInputRefer',
        components: { DemoCompositionInfoColumns, CurdPagination, HfTable, SimpleSearch,
            ...
            rowDbClick(row, column, event) {
                if (this.value) {
                    if (this.valueReferId) {
                        this.$set(this.value, this.valueReferId, row.compositionId)
                    }
                    if (this.valueReferName) {
                        this.$set(this.value, this.valueReferName, row.compositionName)
                    }
