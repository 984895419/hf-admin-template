 ...
 * @type {*[]}
 */
const tableFields = ['permissionId', 'permissionName', 'permissionType', 'appCnt', 'permissionCnt', 'creatorUserName', 'createTime', 'modifierUserName', 'modifyTime', 'enableState', 'deleted']
