    ...
    <el-form ref="form" :model="value">
      <row-span-slot>
        <template v-slot="{ span }">
                    <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="permissionId" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="permissionName" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="permissionType" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="permissionCnt" />
