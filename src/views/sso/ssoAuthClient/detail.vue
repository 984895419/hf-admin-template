    ...
    <el-form ref="form" :model="value">
      <row-span-slot>
        <template v-slot="{ span }">
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="clientId" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="clientSecret" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="redirectUri" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="clientMethodName" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="authorizationGrantTypesNames" />
