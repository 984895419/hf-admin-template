 ...
 * @type {*[]}
 */
const tableFields = ['appId', 'appName', 'noLoginType', 'internetHomeUri', 'creatorUserName', 'createTime', 'modifierUserName', 'modifyTime', 'enableState', 'deleted', 'sort', 'homeUri', 'tokenUri', 'icon', 'protectUri']
