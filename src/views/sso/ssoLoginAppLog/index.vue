    ...
    >
      <template v-slot="{doSave, preferenceData, headerDragend}">
        ...
        >
          ...
          <!-- 显示的字段-->
          <sso-login-app-log-columns :show-fields="showFields" :url-methods="conf.urlMethods" @success="doSearch" />
          <el-table-column
            fixed="right"
...
<script>
    ...
    import SsoLoginAppLogAdd from './add'
    ...
    import SsoLoginAppLogUpdate from './update'
    ...
    import SsoLoginAppLogDetail from './detail'
    import SsoLoginAppLogColumns from './ssoLoginAppLogColumns'
    ...
    export default {
        ...
        components: {
            SsoLoginAppInputRefer,
          SectionTableColumn,
          TemplateConfirmBtn,
          SsoLoginAppLogColumns,
          SsoLoginAppLogDetail,
            CurdTableColumnSelect,
            DelBtn,
          SsoLoginAppLogUpdate,
            CurdPagination,
            HfTable, SsoLoginAppLogAdd,
          FormItemColDict,
          FormItemCol,
          SimpleSearch,
