 ...
 * @type {*[]}
 */
const tableFields = ['menuId', 'menuAlias', 'component', 'menuName', 'menuType', 'i18nMenuName', 'controllerId', 'icon', 'redirect', 'creator', 'createTime', 'modifier', 'modifyTime', 'enableState', 'parentId', 'level', 'levelStr', 'sort', 'deleted']
