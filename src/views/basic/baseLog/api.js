 ...
 * @type {*[]}
 */
const tableFields = ['reqId', 'requestUrl', 'requestHeaders', 'responseHeaders', 'requestMethod', 'requestIp', 'requestParams', 'requestBody', 'responseBody', 'responseStatus', 'creator', 'createTime']
