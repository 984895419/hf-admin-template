 ...
 * @type {*[]}
 */
const tableFields = ['jobTypeId', 'jobTypeName', 'jobTypeKey', 'jobComponentPath', 'javaExpression', 'creator', 'createTime', 'modifier', 'modifyTime', 'enableState', 'deleted', 'tenantId']
