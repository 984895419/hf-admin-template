 ...
 * @type {*[]}
 */
const tableFields = ['configId', 'configKey', 'configValue', 'terminal', 'configDescription', 'creator', 'createTime', 'modifier', 'modifyTime', 'enableState', 'deleted', 'initData', 'tenantId']
