 ...
 * @type {*[]}
 */
const tableFields = ['configId', 'configKey', 'configValue', 'terminal', 'configDescription', 'creatorUserName', 'createTime', 'modifierUserName', 'modifyTime', 'enableState', 'deleted', 'initData', 'tenantId']
