 ...
 * @type {*[]}
 */
const tableFields = ['id', 'tenantKey', 'tenantName', 'tenantDescription', 'tenantInit', 'creator', 'createTime', 'modifier', 'modifyTime', 'enableState', 'deleted', 'initData', 'parentId', 'level', 'levelStr', 'sort']
