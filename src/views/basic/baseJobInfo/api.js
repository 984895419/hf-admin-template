 ...
 * @type {*[]}
 */
const tableFields = ['jobId', 'jobName', 'jobDescription', 'jobData', 'jobTypeId', 'jobTypeName', 'creator', 'createTime', 'modifier', 'modifyTime', 'enableState', 'deleted', 'tenantId', 'runState', 'finishTime']
