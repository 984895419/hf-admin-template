 ...
 * @type {*[]}
 */
const tableFields = ['helperId', 'helperTitle', 'helperContent', 'helperAuthor', 'createTime', 'modifyTime', 'enableState', 'deleted', 'menuId', 'menuIdName', 'creatorUserName', 'modifierUserName']
