  ...
  <div>
    ...
    >
      <div style="margin-top: 10px">
        ...
        >
          <!-- 显示的字段-->
          <hf-base-right-role-resource-columns
...
<script>
    ...
    export default {
        name: 'HfBaseRightRoleResourceInputRefer',
        components: { HfBaseRightRoleResourceColumns, CurdPagination, HfTable, SimpleSearch,
