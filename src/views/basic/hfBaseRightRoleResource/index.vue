<template>
  <el-card class="app-container">
    ...
    <div style="margin-bottom: 10px" class="col-btn-display">
      <hf-base-right-role-resource-add v-permission="[conf.namespace + ':save']" :action-url="conf.urlMethods.addUrl"  @success="doSearch" />
    ...
    <table-column-preference-setting-api-slot
      ...
      <template v-slot="{doSave, preferenceData, headerDragend}">
        ...
        >
          ...
          <!-- 显示的字段-->
          <hf-base-right-role-resource-columns :show-fields="showFields" :url-methods="conf.urlMethods" @success="doSearch" />
          <el-table-column
            fixed="right"
          ...
          >
            ...
            <template slot-scope="scopeRow">
              <div class="col-btn-display">
                <!-- 更新 -->
                <hf-base-right-role-resource-update
                ...
                />
                <!-- 查看 -->
                <hf-base-right-role-resource-detail
                  :value="scopeRow.row"
                />
              </div>
            </template>
...
<script>
    ...
    import HfBaseRightRoleResourceAdd from './add'
    ...
    import HfBaseRightRoleResourceUpdate from './update'
    ...
    import HfBaseRightRoleResourceDetail from './detail'
    import HfBaseRightRoleResourceColumns from './hfBaseRightRoleResourceColumns'
    ...
    export default {
        name: 'HfBaseRightRoleResourceIndexVue',
        components: {
          HfBaseRightRoleInputRefer,
          BaseResourceInputRefer,
          SectionTableColumn,
          TemplateConfirmBtn,
          HfBaseRightRoleResourceColumns,
          HfBaseRightRoleResourceDetail,
            CurdTableColumnSelect,
            DelBtn,
          HfBaseRightRoleResourceUpdate,
            CurdPagination,
            HfTable, HfBaseRightRoleResourceAdd,
          FormItemColDict,
          FormItemCol,
          SimpleSearch,
