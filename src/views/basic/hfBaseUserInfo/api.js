 ...
 * @type {*[]}
 */
const tableFields = ['userId', 'userCode', 'userName', 'pkOrg', 'pkDept', 'gender', 'mobile', 'email', 'ncUserId', 'userFrom', 'creator', 'createTime', 'modifier', 'modifyTime', 'enableState', 'deleted', 'headPic', 'id', 'effectTime']
