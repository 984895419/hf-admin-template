    ...
    <el-form ref="form" :model="value">
      <row-span-slot>
        <template v-slot="{ span }">
          ...
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="microAppId" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="microName" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="microDescription" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="microSecret" />
