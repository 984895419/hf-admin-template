          ...
          >
            ...
            <template slot-scope="scopeRow">
              <div class="col-btn-display">
                ...
                <template-confirm-btn
                  v-if="scopeRow.row.publishState === 0"
                  :url="templateUrl(conf.urlMethods.publishUrl, scopeRow.row)"
                  :btn-type="'text'"
                ...
                <template-confirm-btn
                  v-if="scopeRow.row.publishState === 1"
                  :url="templateUrl(conf.urlMethods.rePublishUrl, scopeRow.row)"
                  :btn-type="'text'"
                  :value="{ publishState : 1}"
                  :label="$t('common.rePublish')"
                  @success="doSearch"
                />
                <template-confirm-btn
                  v-if="scopeRow.row.publishState === 1"
                  :url="templateUrl(conf.urlMethods.cancelPublishUrl, scopeRow.row)"
                  :btn-type="'text'"
...
<script>
    ...
    import WxMenuConfUpdate from './update'
    ...
    import WxMenuConfDetail from './detail'
    import WxMenuConfColumns from './wxMenuConfColumns'
