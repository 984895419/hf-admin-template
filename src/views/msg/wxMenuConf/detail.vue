    ...
    <el-form ref="form" :model="value">
      <row-span-slot>
        <template v-slot="{ span }">
          ...
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="menuContentType" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="menuContent" />
          ...
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="levelInd" />
          ...
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="publishState" />
        </template>
      </row-span-slot>
    </el-form>
  </common-dialog-btn>
