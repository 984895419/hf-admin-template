    ...
    <el-form ref="form" :model="value">
      <row-span-slot>
        <template v-slot="{ span }">
          ...
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="secret" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="token" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="aesKey" />
