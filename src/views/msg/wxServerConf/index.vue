...
<script>
    ...
    import WxServerConfAdd from './add'
    ...
    import WxServerConfUpdate from './update'
    ...
    import WxServerConfDetail from './detail'
    import WxServerConfColumns from './wxServerConfColumns'
