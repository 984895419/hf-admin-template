  ...
  <div>
    ...
    >
      <div style="margin-top: 10px">
        ...
        >
          <!-- 显示的字段-->
          <wx-notify-template-mapping-columns
...
<script>
    ...
    export default {
        name: 'WxNotifyTemplateMappingInputRefer',
        components: { WxNotifyTemplateMappingColumns, CurdPagination, HfTable, SimpleSearch,
            ...
            rowDbClick(row, column, event) {
                if (this.value) {
                    if (this.valueReferId) {
                        this.$set(this.value, this.valueReferId, row.notifyId)
                    }
                    if (this.valueReferName) {
                        this.$set(this.value, this.valueReferName, row.notifyId)
                    }
