...
<script>
    ...
    export default {
        name: 'WxNotifyMessageInputRefer',
        components: { WxNotifyMessageColumns, CurdPagination, HfTable, SimpleSearch,
            ...
            rowDbClick(row, column, event) {
                if (this.value) {
                    if (this.valueReferId) {
                        this.$set(this.value, this.valueReferId, row.msgId)
                    }
                    if (this.valueReferName) {
                        this.$set(this.value, this.valueReferName, row.msgId)
                    }
