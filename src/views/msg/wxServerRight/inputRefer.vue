...
<script>
    ...
    export default {
        name: 'WxServerRightInputRefer',
        components: { WxServerRightColumns, CurdPagination, HfTable, SimpleSearch,
            ...
            rowDbClick(row, column, event) {
                if (this.value) {
                    if (this.valueReferId) {
                        this.$set(this.value, this.valueReferId, row.rightId)
                    }
                    if (this.valueReferName) {
                        this.$set(this.value, this.valueReferName, row.rightId)
                    }
