...
<script>
    ...
    import WxServerRightAdd from './add'
    ...
    import WxServerRightUpdate from './update'
    ...
    import WxServerRightDetail from './detail'
    import WxServerRightColumns from './wxServerRightColumns'
    ...
    export default {
        name: 'WxServerRightIndexVue',
        components: {
          HfBaseUserInfoInputRefer,
          WxServerConfInputRefer,
          SectionTableColumn,
          TemplateConfirmBtn,
          WxServerRightColumns,
          WxServerRightDetail,
            CurdTableColumnSelect,
            DelBtn,
          WxServerRightUpdate,
            CurdPagination,
            HfTable, WxServerRightAdd,
          FormItemColDict,
          FormItemCol,
          SimpleSearch,
