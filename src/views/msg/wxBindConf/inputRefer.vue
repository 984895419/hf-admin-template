...
<script>
    ...
    import WxBindConfColumns from './wxBindConfColumns'
    ...
    export default {
        name: 'WxBindConfInputRefer',
        components: { WxBindConfColumns, CurdPagination, HfTable, SimpleSearch,
            ...
            rowDbClick(row, column, event) {
                if (this.value) {
                    if (this.valueReferId) {
                        this.$set(this.value, this.valueReferId, row.bindId)
                    }
                    if (this.valueReferName) {
                        this.$set(this.value, this.valueReferName, row.bindId)
                    }
