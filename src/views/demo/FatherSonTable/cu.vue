    ...
    <template v-slot="{ closeDialog, data }">
      <cu-form :namespace="conf.namespace" :value="data" :action-method="actionMethod" :form-rules="formRules"
        ...
        <template v-slot="{ errorMessage }">
          ...
          <hf-table :table-data="sonJsonData.list"  :maxheight="200">
            <hf-base-son-columns :show-fields="showFields" />
            <default-table-column
              prop="GoodsCode"
              :label="$t(conf.namespace + '.GoodsName')"
              :namespace="conf.namespace"
              :copyable="true"
              min-width="130"
...
export default {
  ...
  components: { BaseTenantInputRefer, FormItemColDict, FormItemCol, RowSpanSlot, CuForm, AddBtn, UpdateBtn, FormItemColEnableState, HfTable, hfBaseSonColumns,DefaultTableColumn },
  props: {
    value: {
      type: Object,
      default: function () {
